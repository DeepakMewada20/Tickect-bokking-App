...
class TheatreModel {
  ...
  TheatreModel({
    required this.id,
    required this.name,
    this.coordinates = const LatLng(22.7438292,75.8937514),
    ...
    this.fullAddress = "C21 Mall AB Road Near C-21 Mall Sheetal Nagar, Scheme 54 PU4, Indore, Madhya Pradesh 452010",
    this.timings = const [
      "10:00 AM",
      "1:30 PM",
      "6:30 PM",
